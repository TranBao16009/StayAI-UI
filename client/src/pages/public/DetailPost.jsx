  ...
  return (
    <div className="w-full p-4 lg:w-main mx-auto grid grid-cols-7 lg:grid-cols-10 gap-4">
      <div className="col-span-7 my-4 flex flex-col gap-4">
        ...
        <h1 ref={titleRef} className="text-[#007370] font-semibold text-xl">
        ...
        <div className="flex flex-col gap-2">
          <span>
            Thể loại:{" "}
            <span className="text-[#007370] font-medium cursor-pointer hover:underline">
              {post?.rCatalog?.value}
            </span>
          </span>
          <span>
      ...
      <div className="col-span-7 flex flex-col gap-4 lg:col-span-3">
        <div className="p-4 my-4 w-full h-fit border-[#007370] border rounded-md flex flex-col justify-center items-center">
          <img
